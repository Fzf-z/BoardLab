        ...
        return (
            <div className="flex flex-wrap gap-1 mt-2">
                {displayAttrs.map(([key, val]) => (
                    <span key={key} className="text-[10px] bg-gray-700/50 text-gray-400 px-1.5 py-0.5 rounded">
            ...
            <div className="bg-gray-800 rounded-xl shadow-2xl w-full max-w-4xl border border-gray-700 overflow-hidden flex flex-col h-[80vh]">
                ...
                <div className="p-4 bg-gray-800 border-b border-gray-700 flex space-x-2">
                    ...
                    <select
                        ...
                        className="bg-gray-900 border border-gray-600 rounded-lg px-3 py-2 text-white focus:ring-2 focus:ring-blue-500 outline-none"
                    >
                        {boardTypes.map(type => (
